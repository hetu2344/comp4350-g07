...
DROP SEQUENCE IF EXISTS order_serial_seq CASCADE;
...
(
    ...
    order_time TIMESTAMP DEFAULT '2025-03-19 05:20:59.268Z',
...
(
    ...
    changed_at TIMESTAMP DEFAULT '2025-03-19 05:20:59.268Z'
);
